...
CREATE TABLE [Equipments] (
    ...
    CONSTRAINT [FK_Equipments_Heroes_HeroId] FOREIGN KEY ([HeroId]) REFERENCES [Heroes] ([Id]) ON DELETE CASCADE
);
GO
...
VALUES (N'20210629045732_Init', N'5.0.7');
GO
...
ALTER TABLE [Heroes] ADD [DateOfBirth] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210629045829_AddDateOfBirth', N'5.0.7');
GO
